...
function checkAnswer(selectedAnswer) {
    ...
    if (userAnswer === correctAnswer) {
        selectedAnswer.style.backgroundColor = "#c1f7d9"; // Light green for correct answer
    } else {
        // Handle incorrect answer (you can add feedback or other actions here)
    }
}

function checkAnswer2(selectedAnswer) {
    const correctAnswer = "Managing updates, patches, and logical firewall."; // Set the correct answer here
    const userAnswer = selectedAnswer.textContent;
...
function checkAnswer3(selectedAnswer) {
    const correctAnswer = "Pass the risk to a third-party company."; // Set the correct answer here
    const userAnswer = selectedAnswer.textContent;
...
function checkAnswer4(selectedAnswer) {
    const correctAnswer = "Default account created when first creating an amazon account."; // Set the correct answer here
    const userAnswer = selectedAnswer.textContent;
...
function checkAnswer5(selectedAnswer) {
    const correctAnswer = "Virtual Private Cloud is used to create networks within a cloud."; // Set the correct answer here
    const userAnswer = selectedAnswer.textContent;
...
function checkAnswer18(selectedAnswer) {
    const correctAnswer = "Amazon Machine Images. Amazon templates machine image that contains the configuration for applications."; // Set the correct answer here
    const userAnswer = selectedAnswer.textContent;
